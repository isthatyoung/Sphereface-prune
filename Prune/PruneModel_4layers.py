    ...
    for pruning_layer_name in prune_layers:
        ...
        for saving_layer_name in save_layers:
            ...
            if('relu' in saving_layer_name):
                ...
                SaveModelParameter(saving_layer_name, pruning_layer_name,before_prune_solver.net, prune_net, save_indexes, save_layers, been_saved_layers)
